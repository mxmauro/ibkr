...
const file_Contract_proto_rawDesc = "" +
	"\n" +
	"\x0eContract.proto\x12\bprotobuf\x1a\x0eComboLeg.proto\x1a\x1aDeltaNeutralContract.proto\"\xd6\b\n" +
	"\bContract\x12\x19\n" +
	...
	"\tcomboLegs\x18\x14 \x03(\v2\x12.protobuf.ComboLegR\tcomboLegsB\b\n" +
	"\x06_conIdB\t\n" +
	"\a_symbolB\n" +
	"\n" +
	"\b_secTypeB\x1f\n" +
